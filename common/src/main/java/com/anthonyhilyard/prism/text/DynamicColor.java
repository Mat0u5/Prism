...
public final class DynamicColor extends TextColor implements IColor
{
	...
	public static DynamicColor fromARGB(int alpha, int red, int green, int blue)
	{
		return new DynamicColor(new IColor()
		{
			...
			@Override
			public int getIntValue() { return ColorUtil.combineARGB(alpha, red, green, blue); }
	...
	public static DynamicColor fromAHSV(int alpha, int hue, int saturation, int value)
	{
		return new DynamicColor(new IColor()
		{
			...
			@Override
			public int getIntValue() { return ColorUtil.AHSVtoARGB(alpha, hue, saturation, value); }
	...
	public int alpha()		{ return (getIntValue() >> 24) & 0xFF; }
	public int red()		{ return (getIntValue() >> 16) & 0xFF; }
	public int green()		{ return (getIntValue() >> 8)  & 0xFF; }
	public int blue()		{ return (getIntValue() >> 0)  & 0xFF; }
	...
	public int getIntValue()
	{
		...
		else if (values.size() > 1)
		{
			...
			int currentValue = values.get(currentIndex).getIntValue();
			int nextValue = values.get(nextIndex).getIntValue();
		...
		{
			return values.get(0).getIntValue();
		}
	}
